...
WARNING
        ...
        Dir.mktmpdir("libyaml-") do |tmpdir|
          ...
          topic("BUNDLE_CONFIG=#{pwd}/.bundle/config #{bundle_bin} config build.ruby-mcrypt --with-mcrypt-dir=#{build_path}/vendor/mcrypt 2>&1")
          topic(pipe("BUNDLE_CONFIG=#{pwd}/.bundle/config #{bundle_bin} config build.ruby-mcrypt --with-mcrypt-dir=#{build_path}/vendor/mcrypt 2>&1"))
